...
conn_clean = create_engine('mysql+mysqlconnector://root:FarSqlDat081@localhost:3306/clean_tweets')
conn_date = create_engine('mysql+mysqlconnector://root:FarSqlDat081@localhost:3306/update_date')
conn_raw = create_engine('mysql+mysqlconnector://root:FarSqlDat081@localhost:3306/raw_tweets')
...
number_of_tweets = st.number_input('Number of tweets', min_value=1, max_value=100000, value=1, step=1)#st.slider("Number of tweet",min_value=1, max_value=100000)
